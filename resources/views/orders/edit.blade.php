        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <form action="{{ route('orders.update', $order->id) }}" method="POST">
                    ...
                    <div id="product-list">
                        ...
                        <div class="product-item grid grid-cols-3 gap-4 mb-4">
                            <div>
                                ...
                                <select name="products[{{ $loop->index }}][id]" class="w-full border rounded px-2 py-1 product-select" required>
                            ...
                            <div>
                                ...
                                <input type="number" name="products[{{ $loop->index }}][quantity]" class="w-full border rounded px-2 py-1 quantity-input" value="{{ $item->quantity }}" min="1" required>
                            </div>
                    ...
                    <div class="mt-4">
                        <button type="submit" class="bg-blue-500 text-white rounded px-4 py-2 hover:bg-blue-600">Update Order</button>
